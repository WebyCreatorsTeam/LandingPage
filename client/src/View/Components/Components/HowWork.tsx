...
const howWorkList: Array<IHowWorkList> = [
    { img: Meet, alt: "אייקון שני אנשים מדברים", title: "פגישת התנעה", text: "ניפגש כדי להגדיר מטרות של האתר, נבדוק מה האילוצים הטכנולוגיים, נעשה תאום ציפיות", color: "#0DB471" },
    { img: Efiun, alt: "אייקון עיצוב אתר", title: "איפיון ועיצוב", text: "נדייק מי הלקוחות שלך, מי המתחרים, נבנה סקיצות ראשוניות נחליט על צבעים ופונטים של האתר", color: "#DF9A0D" },
