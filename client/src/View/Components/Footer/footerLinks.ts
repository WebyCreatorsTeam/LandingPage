...
export const footerlinks: Array<FooterLinks> = [
    {img: FaceBook,alt: "facebook", url: "https://www.facebook.com/profile.php?id=61554785497612"},
    {img: LinkedIn,alt: "linkedin",url: "www.linkedin.com/in/weby-creators-team"},
